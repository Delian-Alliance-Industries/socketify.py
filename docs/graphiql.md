## GraphiQL Support
In [`/src/examples/helper/graphiql.py`](https://github.com/Delian-Alliance-Industries/socketify.py/blob/main/examples/graphiql.py) we implemented an helper for using graphiQL with strawberry.
